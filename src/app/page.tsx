...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-slate-50 to-white">
      {/* Header */}
      <header className="px-4 lg:px-6 h-16 flex items-center justify-between border-b border-slate-200/60 sticky top-0 bg-white/80 backdrop-blur-md z-40">
      ...
      <main className="flex-1">
        ...
        <section className="relative w-full py-16 md:py-24 lg:py-32 overflow-hidden">
          ...
          <div className="absolute inset-0 -z-10">
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-bl from-indigo-100/50 to-transparent rounded-full blur-3xl" />
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-gradient-to-tr from-purple-100/50 to-transparent rounded-full blur-3xl" />
          </div>
            ...
            <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
              <div className="flex flex-col justify-center space-y-8">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-50 border border-indigo-100 w-fit">
                  ...
                  <span className="text-sm font-medium text-indigo-700">Trusted by 500+ teams worldwide</span>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="max-w-[540px] text-lg text-slate-600 leading-relaxed">
                ...
                <div className="flex items-center gap-6 pt-4">
                  ...
                  <div className="text-sm text-slate-600">
                    <span className="font-semibold text-slate-900">500+</span> teams trust TimeOffer
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-center lg:justify-end">
                <div className="relative">
                  ...
                  <div className="relative w-full max-w-lg overflow-hidden rounded-2xl shadow-2xl shadow-slate-900/10 border border-slate-200/50 bg-white">
          ...
          <MaxWidthWrapper>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <Card key={index} className="group relative overflow-hidden border-slate-200/50 hover:border-indigo-200 hover:shadow-lg hover:shadow-indigo-500/5 transition-all duration-300">
        ...
        <section id="how-it-works" className="w-full py-20 lg:py-28 bg-gradient-to-b from-slate-50 to-white">
          <MaxWidthWrapper>
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {[
                ...
                <div key={index} className="relative flex flex-col items-center text-center space-y-4 p-6">
                  {index < 2 && (
                    <div className="hidden md:block absolute top-16 left-[60%] w-[80%] h-[2px] bg-gradient-to-r from-indigo-300 to-purple-300" />
                  )}
                  <div className="relative">
                  ...
                  <p className="text-slate-600 max-w-[280px]">{item.description}</p>
                </div>
              ))}
            </div>
          </MaxWidthWrapper>
          ...
          <div className="py-12 md:py-16">
            <div className="grid gap-8 md:grid-cols-4">
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <span className="text-sm text-slate-400 cursor-not-allowed">Pricing (Coming soon)</span>
                  </li>
                  <li>
                    <span className="text-sm text-slate-400 cursor-not-allowed">Integrations (Coming soon)</span>
                  </li>
                  <li>
                    <span className="text-sm text-slate-400 cursor-not-allowed">Changelog (Coming soon)</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2">
                  <li>
                    <span className="text-sm text-slate-400 cursor-not-allowed">About (Coming soon)</span>
                  </li>
                  <li>
                    <span className="text-sm text-slate-400 cursor-not-allowed">Blog (Coming soon)</span>
                  </li>
                  <li>
                    <span className="text-sm text-slate-400 cursor-not-allowed">Careers (Coming soon)</span>
                  </li>
                  <li>
                    <span className="text-sm text-slate-400 cursor-not-allowed">Contact (Coming soon)</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2">
                  <li>
                    <span className="text-sm text-slate-400 cursor-not-allowed">Privacy Policy (Coming soon)</span>
                  </li>
                  <li>
                    <span className="text-sm text-slate-400 cursor-not-allowed">Terms of Service (Coming soon)</span>
                  </li>
                  <li>
                    <span className="text-sm text-slate-400 cursor-not-allowed">Cookie Policy (Coming soon)</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="mt-12 pt-8 border-t border-slate-200 flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              <div className="flex items-center gap-4">
                <Link href="/" className="text-slate-400 hover:text-indigo-600 transition-colors" aria-label="Follow us on Twitter">
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                  </svg>
                </Link>
                <Link href="/" className="text-slate-400 hover:text-indigo-600 transition-colors" aria-label="View our GitHub">
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <Link href="/" className="text-slate-400 hover:text-indigo-600 transition-colors" aria-label="Connect with us on LinkedIn">
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
